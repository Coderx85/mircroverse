...
export type TProduct = ProductDbSchema;
...
export type TCategory = CategoryDbSchema;
...
export type TProductFormInputs = z.infer<typeof ProductFormSchema>;

export type TCategoryFormInputs = z.infer<typeof CategoryFormSchema>;

export type TProductSearchQuery = GetProductsQuery;
